...
public class VSACSharedConstants {
	...
	public static final String PROXY_HOSTNAME = "10.100.1.224";
	...
	// URL constants
	/*public static final String SERVER_TICKET = "https://vsac.nlm.nih.gov/vsac/ws/Ticket";
	public static final String SERVER_SINGLE_VALUESET = "https://vsac.nlm.nih.gov/vsac/ws/RetrieveValueSet?";
	public static final String SERVER_MULTIPLE_VALUESET = "https://vsac.nlm.nih.gov/vsac/ws/RetrieveMultipleValueSets?";
	public static final String SERVICE = "http://umlsks.nlm.nih.gov";*/
	
	public static final String SERVER_TICKET = System.getProperty("SERVER_TICKET_URL");
	public static final String SERVER_SINGLE_VALUESET = System.getProperty("SERVER_SINGLE_VALUESET_URL");
	public static final String SERVER_MULTIPLE_VALUESET = System.getProperty("SERVER_MULTIPLE_VALUESET_URL");
	...
	public static String retrieveLatestVersionValueSetURL(String id,
		...
		return SERVER_SINGLE_VALUESET + "id=" + id + "&ticket=" + serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes";
	}

	public static String retrieveSpecifiedValueSetWithVersionURL(String id,
			String serviceTicket, String version) {
		System.out.println("VSAC URL:"+SERVER_SINGLE_VALUESET + "id=" + id + "&version=" + version
				+ "&ticket=" + serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
	...
	public static String retrieveSpecifiedValueSetWithEffectiveDateURL(
		...
		System.out.println("VSAC URL:"+SERVER_SINGLE_VALUESET + "id=" + id + "&effectiveDate="
				+ effectiveDate + "&ticket=" + serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
	...
	public static String retrieveMultipleValueSetsWithOID(String id,
			String serviceTicket) {
		System.out.println("VSAC URL:"+SERVER_MULTIPLE_VALUESET + "id=" + id + "&ticket="
	...
	public static String retrieveMultipleValueSetsWithOIDAndVersion(String id,
		...
		System.out.println("VSAC URL:"+SERVER_MULTIPLE_VALUESET + "id=" + id + "&version=" + version
				+ "&ticket=" + serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
	...
	public static String retrieveMultipleValueSetsWithOIDAndEffectiveDate(
		...
		System.out.println("VSAC URL:"+SERVER_MULTIPLE_VALUESET + "id=" + id + "&effectiveDate="
				+ version + "&ticket=" + serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
	...
	public static String retrieveMultipleValueSetsWithCMSeMeasureIdentifier(
		...
		System.out.println("VSAC URL:"+SERVER_MULTIPLE_VALUESET + "cmsemeasureid=" + CMSeMeasureID
				+ "&ticket=" + serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
	...
	public static String retrieveMultipleValueSetsWithNQFNumber(
		...
		System.out.println("VSAC URL:"+SERVER_MULTIPLE_VALUESET + "NQFNumber=" + NQFNumber + "&ticket="
				+ serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
	...
	public static String retrieveMultipleValueSetsWithMeasureID(
		...
		System.out.println("VSAC URL:"+SERVER_MULTIPLE_VALUESET + "measureid=" + MeasureID + "&ticket="
				+ serviceTicket + "&ReleaseType=VSAC&IncludeDraft=yes");
